      ...
      {isMenuOpen && (
        <div className="absolute m-0  sm:h-80 pop-up top-20 flex-col sm:flex-row flex bg-white w-full items-center sm:items-end sm:justify-center">
          <div
            ...
            className="bg-slate-500 w-4/5 sm:w-1/4 flex flex-col justify-center mt-10 items-center mb-10 mr-2 rounded-lg h-1/4 sm:h-1/2"
          >
            <div className="flex flex-col justify-center  items-center ">
              ...
              <div className="pb-10 text-sm font-semibold  text-gray-400 mt-2">
                <a href="/headphones" className="flex">
                  SHOP{" "}
                  <Image
          ...
          <div
            style={{ backgroundColor: "#F1F1F1" }}
            className="bg-slate-500 w-4/5 sm:w-1/4  flex flex-col justify-center items-center mb-10 mr-2 h-1/4 sm:h-1/2 rounded-lg"
          >
            <div className="flex flex-col justify-center items-center">
              <Image
              ...
              <div className="pb-10 text-sm font-semibold text-gray-400 mt-2">
                <a href="/speakers" className="flex">
                  SHOP{" "}
                  <Image
                    src="/shared/desktop/icon-arrow-right.svg"
                    width={10}
          ...
          <div className="m-5 flex flex-col">
            <div className="flex justify-between ">
              <div className="text-xl font-semibold tracking-wide">
                CART ({initialCartItems.length})
              </div>
              <div className="underline cursor-pointer" onClick={removeItems}>
                Remove all
              </div>
            </div>
            {initialCartItems.map((item: Item, index: number) => (
              ...
              >
                ...
                <Button
                  key={index}
                  number={item.units}
                  onChangeUnits={(newUnits: number) =>
                    updateItemUnits(index, newUnits)
                  }
                />
              </div>
            ))}
            ...
            <button
              ...
              className="bg-amber-600 text-white mt-3 h-12"
            >
              Checkout
            </button>
          </div>
