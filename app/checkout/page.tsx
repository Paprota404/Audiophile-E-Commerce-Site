...
const Checkout = () => {
  ...
  const { cartItems: initialCartItems, setCartItems } =
    React.useContext(CartInfo);
  const [cartItemsState, setCartItemsState] = useLocalStorage(
    "cartItems",
    initialCartItems
  );
  ...
  let totally = initialCartItems.reduce(
    (total: number, item: Item) => total + item.price * item.units,
    0
  );
  ...
  return (
    <div className="mb-32">
          ...
          <div className="m-10">
            ...
            <form className="mt-4 grid sm:grid-cols-2 gap-8">
              <div className="flex flex-col">
                ...
                <input
                  className="border-2 rounded-lg h-12 w-full pl-4"
                  type="text"
                  id="name"
                  name="name"
                  placeholder="Forms"
            ...
            <form className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  id="country"
                  name="country"
                  placeholder="to check application"
                  required
                ></input>
              </div>
            </form>
              ...
              <div>
                <div className="border-2 rounded-lg h-12 w-full mb-5 pl-4 flex items-center">
                  <input
                    ...
                    required
                  ></input>
                  <label className="text-sm font-bold mb-2 mt-2 ml-2">
                    e-Money
                  </label>
                </div>
        ...
        <div className="checkout-bg rounded-lg lg:w-3/12 h-full flex justify-center">
          <div className="flex flex-col m-6 gap-6 w-4/5">
            ...
            <button
              ...
              className="bg-amber-600 w-full h-12 text-white text-sm"
            >
              CONTINUE & PAY
            </button>
          </div>
      ...
      {orderVisible && (
        <div className="fixed order rounded-lg p-10 w-72 sm:w-144 z-50 bg-white">
          <Image
            ...
            alt="Order Placed"
          ></Image>
          <h1 className="lg:text-3xl text-2xl font-bold my-6">
            ...
            <div className="flex sm:flex-row flex-col orderbg w-full rounded-lg mt-5">
              <div className="flex flex-col sm:w-7/12   gap-3 m-4">
                <div className="flex ml-3  items-center text-lg">
                  ...
                  ></Image>
                  <div className="flex flex-col">
                    <div className="text-semibold text-lg font-bold">
                      {cartItemsState[0].name}
                    </div>
                    <div>${cartItemsState[0].price}</div>
                  </div>

                  <div className="text-lg ml-auto">
                    x{cartItemsState[0].units}
                  </div>
                </div>
                ...
                <div className="self-center">
                  and {initialCartItems.length - 1} other item(s)
                </div>
              </div>

              <div className="sm:w-5/12 bg-black flex flex-col justify-center  rounded-r-lg ">
                <div className="text-stone-400 ml-3 mt-2 text-lg">
                  GRAND TOTAL
                </div>
          ...
          <Link href="/">
            <button className="bg-amber-600 w-full mt-12 h-12">
